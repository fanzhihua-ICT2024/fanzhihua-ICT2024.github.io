...
- **[TACO-26]** [TOSCA: Towards Semi-Centralized Scheduling in Dataflow Architectures via Hardware-Software Co-Design](). Shantian Qin, **Zhihua Fan\***, Haibin Wu, Kunming Zhang, Yu Liu, Haoran Tong, Xiaochun Ye, Dongrui Fan. In ACM Transactions on Architecture and Code Optimization. **(_CCF-A, Corresponding Author_)**
- **[TOCS-26]** [ M^2-DFU: Multi-Mode Dataflow Architecture for Adaptive and High-Efficiency Data Processing](). Wenming Li, **Zhihua Fan\***,  Dongrui Fan, Xiaochun Ye, Wenming Li. In ACM Transactions on Architecture and Code Optimization. **(_CCF-A, Corresponding Author_)**
