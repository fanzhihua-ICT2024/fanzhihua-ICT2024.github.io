...
- **[DAC-26]** [AHASD: Asynchronous Heterogeneous Architecture for LLM Adaptive Drafting Speculative Decoding on Mobile Devices ]().  Zirui Ma,**Zhihua Fan\***,  Wenxing Li, Haibin Wu, Fulin Zhang, Wenming Li and Xiaochun Ye. In Design Automation Conference (Just Accept) . **(_CCF-A, Corresponding Author_)**
- **[TACO-26]** [TOSCA: Towards Semi-Centralized Scheduling in Dataflow Architectures via Hardware-Software Co-Design](). Shantian Qin, **Zhihua Fan\***, Dongrui Fan, Xiaochun Ye, Wenming Li. In ACM Transactions on Architecture and Code Optimization. **(_CCF-A, Corresponding Author_)**
- **[TOCS-26]** [ M^2-DFU: Multi-Mode Dataflow Architecture for Adaptive and High-Efficiency Data Processing](). Wenming Li, **Zhihua Fan\***,  Haibin Wu, Kunming Zhang, Yu Liu, Haoran Tong, Xiaochun Ye, Dongrui Fan. In ACM ACM Transactions on Computer Systems. **(_CCF-A, Corresponding Author_)**
...
- **[TCAD-26]** [A Scalable RISC-V Extended Infrastructure for Unstructured SpMM in LLM Inference with Vectorizable Sparse Format](). Tengfei Xia,**Zhihua Fan\***, Jing Xue, Teng Luo, Shantian Qin, Xiaochun Ye, Dongrui Fan, Wenming Li. In IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems (Just Accept). **(_CCF-A, Corresponding Author_)**
...
- **[ICCD-26]** [MPMap: Fast Mapping for Spatial Accelerators via Learned Mappability Prediction](). Shengzhong Tang, **Zhihua Fan\***, Tianyu Liu, Qingxiao Sun, Lei Liu, Xuejun An，Xiaochun Ye and Wenming Li. In International Conference on Computer Design. **(_CCF-B, Corresponding Author_)**
- **[DATE-26]** [A2RT: Efficient Ray Tracing Accelerator with Approximate-Accurate Computing and Quantization](https://ieeexplore.ieee.org/document/11539459). Zhiyuan Zhang, **Zhihua Fan\***, Wenming Li, Yudong Mu, Yuhang Qiu, Zhen Wang, Xiaochun Ye and Xuejun An. In In Design, Automation & Test in Europe Conference & Exhibition (Just Accept). **(_CCF-B, Corresponding Author_)**
- **[DATE-26]** [RISC-V ISA Extensions for Vectorized Unstructured Sparse SpMM in LLM Inference](). Tengfei Xia,**Zhihua Fan\***, Jing Xue, Shantian Qin, Xiaochun Ye and Wenming Li. In In Design, Automation & Test in Europe Conference & Exhibition 2026, pp 1-7. **(_CCF-B, Corresponding Author_)**
...
- **[JSA-26]** [RVM-LBC: Acceleration of NTT for Efficient LBC With Custom RISC-V Vector-Matrix Processor](https://www.sciencedirect.com/science/article/abs/pii/S1383762125003078). Yuhang Qiu, **Zhihua Fan\***, Jing Xue, Zhen Wang, Wenming Li, Xiaochun Ye and Zhimin Tang. In Journal of Systems Architecture(Just Accept). **(_CCF-B, Corresponding Author_)**
- **[FCS-26]** [Striking the Mantissa: How Few Bits are Enough for Accurate DNN Inference?]((https://journal.hep.com.cn/fcs/EN/10.1007/s11704-025-51210-5)). Zhiyuan Zhang, Ping Zhang, **Zhihua Fan\***, Wenming Li, Xiaochun Ye and Xuejun An. In Frontiers of Computer Science, 21(5), 2027. **(_CCF-B, Corresponding Author_)**
- **[FCS-26]** [DFU-L: A Latency-Sensitive Dataflow Architecture with NoC and Streaming Optimizations for Edge DSP](). Haibin Wu, **Zhihua Fan**, Zhen Wang, Zirui Ma, Wenxing Li, Haoran Tong, Tengfei Xia, Xiaochun Ye and Wenming Li. In Frontiers of Computer Science (Just Accept). **(_CCF-B_)**
- **[FGCS-26]** [HALO: A Heterogeneous Accelerator for Low-Latency and Energy-Efficient Edge LLM Inference](https://www.sciencedirect.com/science/article/pii/S0167739X26002803). Kunming Zhang, **Zhihua Fan\***, Yanhuan Liu, Lexin Wang, Yuqun Liu, Haibin Wu, Xiaochun Ye and Wenming Li. In Future Generation Computer Systems, Volume 185, 2026. **(_CCF-C, Corresponding Author_)**
- **[Scientific Reports-26]** [An Interpolation-Oriented Dataflow Architecture for Efficient Real-Time Image Processing](). Ping Zhang, Hongxue Yang, Zixia Wang, Xihao Yang, **Zhihua Fan** and Wenming Li. In Scientific Reports(Just Accept). **(Nature Portfolio Journal)**
- **[TACO-25]** [Compressing and Accelerating Sparse CNNs Using Sign-Reserved Toeplitz Filters and Input Activation Density-aware Dataflow](https://dl.acm.org/doi/10.1145/3773995). Zhen Wang, Tianyu Liu, **Zhihua Fan\***, Wenming Li, Yuhang Qiu, Zhiyuan Zhang, Xuejun An, Xiaochun Ye, and Dongrui Fan. In ACM Transactions on Architecture and Code Optimization, Volume 22, Issue 4, Article 148. **(_CCF-A, Corresponding Author_)**
- **[TACO-25]** [DFGAS: Exploring the Balance of HW-SW Scheduling through the DFG-Aware Scheme](https://dl.acm.org/doi/10.1145/3773768). Tianyu Liu, **Zhihua Fan\***, Wenming Li, Zhen Wang, Yuhang Qiu, Shengzhong Tang, Haibin Wu, Yanhuan Liu, Xiaochun Ye, and Dongrui Fan. In ACM Transactions on Architecture and Code Optimization,Volume 22, Issue 4, Article 147. **(_CCF-A, Corresponding Author_)**
...
- **[APPT-25]**  [NFMap: Node Fusion Optimization for Efficient CGRA Mapping with Reinforcement Learning]((https://link.springer.com/chapter/10.1007/978-981-95-1021-4_5)).Yudong Mu, Siyi Li, **Zhihua Fan\***, Wenming Li, Xuejun An and Xiaochun Ye. In International Symposium on Advanced Parallel Processing Technology, PP.61-73. **(_CCF-C, Corresponding Author_)**
- **[HPCC-25]**  [TSCNN: Compressing and Accelerating Sparse CNNs Using Sign-Reserved Toeplitz Filters](https://ieeexplore.ieee.org/document/11207373/). Zhen Wang, Tianyu Liu, **Zhihua Fan\***, Yuhang Qiu, Zhiyuan Zhang, Wenming Li, Xiaochun Ye, Dongrui Fan. In IEEE International Conference on High Performance Computing and Communications,2025, pp. 290-297. **(_CCF-C, Corresponding Author_)**
- **[NPC-25]** [LightCacheRL: A Lightweight Reinforcement Learning Framework for Unified Cache Management](). Kunming Zhang, **Zhihua Fan**, Yingchun Fu, Yanhuan Liu, Lexin Wang, Yuqun Liu, Haibin Wu, Wenming Li. Network and Parallel Computing. NPC 2025. Lecture Notes in Computer Science, vol 16305. **(_CCF-C_)**
...
-  **[HPCC-24]**  [OBSD: On-The-Fly Block-Wise Sparse Distillation Accelerating SpGEMMs in DNN Applications](https://ieeexplore.ieee.org/document/11083155). Liu, Yanhuan and Li, Wenming and Zhang, Kunming and **Zhihua Fan** and Wu, Haibin and Wang, Lexin and Liu, Tianyu and Qiu, Yuhang and Wang, Zhen and Ye, Xiaochun and Fan, Dongrui and An, Xuejun. In IEEE International Conference on High Performance Computing and Communications, pp224-231. **(_CCF-C_)**
...
- ICT Director's Scholarship（计算所所长奖）
...
- Top-Pick Team Award, APPT 2026 Student GPU Programming Challenge

## 👨‍🏫 Services {#services}

- Program Committee Member: HPCA 2027, NAS 2026, CCF CHIP 2026, ChinaSYS 2026, ISPA 2025, HPC-China 2025, ChinaSYS 2025......
- Journal Reviewer: ACM TACO，IEEE TCAD、CCF THPC，JPDC、JSA，FGCS......
